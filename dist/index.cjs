...
_walletClient = /* @__PURE__ */ new WeakMap();
var _provider;
var _switchChain;
var switchChain_fn;
...
var ImpersonatedConnector = class extends Connector {
  id = "impersonated";
  name = "Impersonated";
  ready = true;
  account;
...
function createWalletSlice({
  ...
  return (set, get) => ({
    ...
    setImpersonated: (privateKeyOrAddress) => {
      if ((0, import_viem17.isAddress)(privateKeyOrAddress)) {
        set({
          impersonated: {
        ...
        set({
          impersonated: {
            account: (0, import_accounts.privateKeyToAccount)(`0x${privateKeyOrAddress}`),
            isViewOnly: false
          }
        });
      }
