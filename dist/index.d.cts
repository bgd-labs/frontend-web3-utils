...
type ConnectorType = InjectedConnector | WalletConnectConnector | CoinbaseWalletConnector | SafeConnector;
...
type WalletType = 'Metamask' | 'WalletConnect' | 'Coinbase' | 'GnosisSafe';
...
declare const initialChains: Record<number, Chain>;
declare const initChainInformationConfig: (chains?: Record<number, Chain>) => {
    clientInstances: {
        [chainId: number]: {
...
declare const selectTxExplorerLink: <T extends BaseTx>(state: ITransactionsState<T>, getChainParameters: (chainId: number) => Chain, txHash: string) => string;
