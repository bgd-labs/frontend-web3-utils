...
import { mainnet, polygon, polygonMumbai, avalanche, avalancheFuji, goerli, sepolia, optimism, arbitrum } from 'viem/chains';
import { createPublicClient, http, fallback, webSocket, getAddress, UserRejectedRequestError, ResourceUnavailableRpcError, createWalletClient, custom, numberToHex, SwitchChainError } from 'viem';
...
var LocalStorageKeys = /* @__PURE__ */ ((LocalStorageKeys2) => {
  LocalStorageKeys2["LastConnectedWallet"] = "LastConnectedWallet";
  LocalStorageKeys2["TransactionPool"] = "TransactionPool";
  return LocalStorageKeys2;
})(LocalStorageKeys || {});
var setLocalStorageTxPool = (pool) => {
  const stringifiedPool = JSON.stringify(pool);
  localStorage.setItem("TransactionPool" /* TransactionPool */, stringifiedPool);
};
var getLocalStorageTxPool = () => {
  return localStorage.getItem("TransactionPool" /* TransactionPool */);
};
var setLocalStorageWallet = (walletType) => {
  localStorage.setItem("LastConnectedWallet" /* LastConnectedWallet */, walletType);
};
var deleteLocalStorageWallet = () => {
  localStorage.removeItem("LastConnectedWallet" /* LastConnectedWallet */);
  localStorage.removeItem("wagmi.wallet");
};
var clearWalletLinkLocalStorage = () => {
...
var clearWalletConnectV2LocalStorage = () => {
...
var selectIsGelatoTXPending = (gelatoStatus) => {
  return gelatoStatus === void 0 || gelatoStatus === "CheckPending" || gelatoStatus === "WaitingForConfirmation" || gelatoStatus === "ExecPending";
};

// src/web3/adapters/GelatoAdapter.ts
function isGelatoTx(tx) {
  return tx.taskId !== void 0;
}
...
var GelatoAdapter = class {
  ...
  stopPollingGelatoTXStatus = (taskId) => {
    const currentInterval = this.transactionsIntervalsMap[taskId];
    clearInterval(currentInterval);
    this.transactionsIntervalsMap[taskId] = void 0;
  };
  fetchGelatoTXStatus = async (taskId) => {
  ...
  updateGelatoTX = (taskId, statusResponse) => {
    this.set(
      (state) => produce(state, (draft) => {
        ...
        tx.status = statusResponse.task.taskState === "ExecSuccess" ? 1 : tx.pending ? void 0 : 0;
...
var alphawallet = {
  identityFlag: "isAlphaWallet" /* AlphaWallet */,
  label: "Alpha Wallet" /* AlphaWallet */,
...
// src/utils/wallets/wallets/atoken.ts
var atoken = {
  identityFlag: "isAToken" /* AToken */,
  label: "AToken Wallet" /* AToken */,
...
// src/utils/wallets/wallets/binance.ts
var binance = {
  identityFlag: "bbcSignTx" /* Binance */,
  label: "Binance Smart Wallet" /* Binance */,
...
// src/utils/wallets/wallets/bitkeep.ts
var bitkeep = {
  identityFlag: "isBitKeep" /* BitKeep */,
  label: "BitKeep Wallet" /* BitKeep */,
...
// src/utils/wallets/wallets/bitpie.ts
var bitpie = {
  identityFlag: "isBitpie" /* Bitpie */,
  label: "Bitpie Wallet" /* Bitpie */,
...
// src/utils/wallets/wallets/bitski.ts
var bitski = {
  identityFlag: "isBitski" /* Bitski */,
  label: "Bitski Wallet" /* Bitski */,
...
// src/utils/wallets/wallets/blockwallet.ts
var blockwallet = {
  identityFlag: "isBlockWallet" /* BlockWallet */,
  label: "Block Wallet" /* BlockWallet */,
...
// src/utils/wallets/wallets/brave.ts
var brave = {
...
// src/utils/wallets/wallets/coinbase.ts
var coinbase = {
  identityFlag: "isToshi" /* Coinbase */,
...
// src/utils/wallets/wallets/core.ts
var core = {
  identityFlag: "isAvalanche" /* Core */,
  label: "Core Wallet" /* Core */,
...
// src/utils/wallets/wallets/dcent.ts
var dcent = {
  identityFlag: "isDcentWallet" /* Dcent */,
  label: "D'CENT Wallet" /* Dcent */,
...
// src/utils/wallets/wallets/defiwallet.ts
var defiwallet = {
  identityFlag: "isDeficonnectProvider" /* DeFiWallet */,
  label: "DeFi Wallet" /* DeFiWallet */,
...
// src/utils/wallets/wallets/enkrypt.ts
var enkrypt = {
  identityFlag: "isEnkrypt" /* Enkrypt */,
  label: "Enkrypt" /* Enkrypt */,
...
// src/utils/wallets/wallets/exodus.ts
var exodus = {
  identityFlag: "isExodus" /* Exodus */,
  label: "Exodus" /* Exodus */,
...
// src/utils/wallets/wallets/frame.ts
var frame = {
  identityFlag: "isFrame" /* Frame */,
  label: "Frame" /* Frame */,
...
// src/utils/wallets/wallets/frontier.ts
var frontier = {
  identityFlag: "isFrontier" /* Frontier */,
  label: "Frontier" /* Frontier */,
...
// src/utils/wallets/wallets/gamestop.ts
var gamestop = {
  identityFlag: "isGamestop" /* GameStop */,
  label: "GameStop Wallet" /* GameStop */,
...
// src/utils/wallets/wallets/huobiwallet.ts
var huobiwallet = {
  identityFlag: "isHbWallet" /* HuobiWallet */,
  label: "Huobi Wallet" /* HuobiWallet */,
...
// src/utils/wallets/wallets/hyperpay.ts
var hyperpay = {
  identityFlag: "isHyperPay" /* HyperPay */,
  label: "HyperPay" /* HyperPay */,
...
// src/utils/wallets/wallets/imtoken.ts
var imtoken = {
  identityFlag: "isImToken" /* ImToken */,
  label: "imToken" /* ImToken */,
...
// src/utils/wallets/wallets/liquality.ts
var liquality = {
  identityFlag: "isLiquality" /* Liquality */,
  label: "Liquality" /* Liquality */,
...
// src/utils/wallets/wallets/mathwallet.ts
var mathwallet = {
  identityFlag: "isMathWallet" /* MathWallet */,
  label: "MathWallet" /* MathWallet */,
...
// src/utils/wallets/wallets/meetone.ts
var meetone = {
  identityFlag: "wallet" /* MeetOne */,
  label: "MeetOne" /* MeetOne */,
...
// src/utils/wallets/wallets/metamask.ts
var metamask = {
  identityFlag: "isMetaMask" /* MetaMask */,
  label: "MetaMask" /* MetaMask */,
...
// src/utils/wallets/wallets/mykey.ts
var mykey = {
  identityFlag: "isMYKEY" /* MyKey */,
  label: "MyKey" /* MyKey */,
...
// src/utils/wallets/wallets/okxwallet.ts
var okxwallet = {
  identityFlag: "isOkxWallet" /* OKXWallet */,
  label: "OKX Wallet" /* OKXWallet */,
...
// src/utils/wallets/wallets/oneInch.ts
var oneInch = {
  identityFlag: "isOneInchIOSWallet" /* OneInch */,
  label: "1inch" /* OneInch */,
...
// src/utils/wallets/wallets/opera.ts
var opera = {
  identityFlag: "isOpera" /* Opera */,
  label: "Opera" /* Opera */,
...
// src/utils/wallets/wallets/ownbit.ts
var ownbit = {
  identityFlag: "isOwnbit" /* OwnBit */,
  label: "OwnBit" /* OwnBit */,
...
// src/utils/wallets/wallets/phantom.ts
var phantom = {
...
// src/utils/wallets/wallets/rabby.ts
var rabby = {
  identityFlag: "isRabby" /* Rabby */,
  label: "Rabby" /* Rabby */,
...
// src/utils/wallets/wallets/rainbow.ts
var rainbow = {
  identityFlag: "isRainbow" /* Rainbow */,
...
// src/utils/wallets/wallets/safepal.ts
var safepal = {
  identityFlag: "isSafePal" /* SafePal */,
  label: "SafePal" /* SafePal */,
...
// src/utils/wallets/wallets/sequence.ts
var sequence = {
  identityFlag: "isSequence" /* Sequence */,
...
// src/utils/wallets/wallets/status.ts
var status = {
  identityFlag: "isStatus" /* Status */,
  label: "Status" /* Status */,
...
// src/utils/wallets/wallets/tallywallet.ts
var tallywallet = {
  identityFlag: "isTally" /* Tally */,
  label: "Tally Ho Wallet" /* Tally */,
...
// src/utils/wallets/wallets/tokenary.ts
var tokenary = {
  identityFlag: "isTokenary" /* Tokenary */,
  label: "Tokenary Wallet" /* Tokenary */,
...
// src/utils/wallets/wallets/tokenpocket.ts
var tokenpocket = {
  identityFlag: "isTokenPocket" /* TokenPocket */,
  label: "TokenPocket" /* TokenPocket */,
...
// src/utils/wallets/wallets/tp.ts
var tp = {
  identityFlag: "isTp" /* TP */,
  label: "TP Wallet" /* TP */,
...
// src/utils/wallets/wallets/trust.ts
var trust = {
  identityFlag: "isTrust" /* Trust */,
  label: "Trust Wallet" /* Trust */,
...
// src/utils/wallets/wallets/walletio.ts
var walletio = {
  identityFlag: "isWalletIO" /* WalletIo */,
  label: "Wallet.io" /* WalletIo */,
...
// src/utils/wallets/wallets/xdefi.ts
var xdefi = {
  identityFlag: "isXDEFI" /* XDEFI */,
  label: "XDEFI Wallet" /* XDEFI */,
...
// src/utils/wallets/wallets/zeal.ts
var zeal = {
  identityFlag: "isZeal" /* Zeal */,
  label: "Zeal Wallet" /* Zeal */,
...
// src/utils/wallets/wallets/zerion.ts
var zerion = {
  identityFlag: "isZerion" /* Zerion */,
  label: "Zerion" /* Zerion */,
...
// src/utils/wallets/wallets/defaultWallet.ts
var defaultWallet = {
...
// src/utils/wallets/getBrowserWalletLabelAndIcon.ts
...
var _provider;
var InjectedConnector2 = class extends Connector {
  constructor({
    chains,
    options: options_
  } = {}) {
...
var Config = class {
  constructor({
    autoConnect = false,
    connectors = [new InjectedConnector2()],
    publicClient,
    ...
    if (autoConnect) {
      try {
        ...
        status2 = data?.account ? "reconnecting" : "connecting";
...
function getAccount() {
  const { data, connector, status: status2 } = getConfig();
  switch (status2) {
    case "connected":
      return {
...
function watchAccount(callback, { selector = (x) => x } = {}) {
  ...
  const unsubscribe = config2.subscribe(
    ({ data, connector, status: status2 }) => selector({
      address: data?.account,
      connector,
      status: status2
    }),
...
function Child({
  ...
  const { setConnectors, changeActiveWalletAccount, changeActiveWalletChain } = useStore();
...
var GnosisAdapter = class {
  ...
  fetchGnosisTxStatus = async (txKey) => {
    const tx = this.get().transactionsPool[txKey];
    const response = await fetch(
  ...
  stopPollingGnosisTXStatus = (txKey) => {
    const currentInterval = this.transactionsIntervalsMap[txKey];
    clearInterval(currentInterval);
    this.transactionsIntervalsMap[txKey] = void 0;
  };
...
function createTransactionsSlice({
  ...
  return (set, get) => ({
    ...
    // TODO: think when to init, maybe only when working with gelato or it's available
    ethereumAdapter: new EthereumAdapter(get, set),
    // This might be a Gnosis Safe adapter, re-inits when wallet.type === GnosisSafe
    executeTx: async ({ body, params }) => {
      ...
      return isGelatoTx(tx) ? get().gelatoAdapter.executeTx(args) : get().ethereumAdapter.executeTx(args);
    },
    addTXToPool: (transaction, walletType) => {
      ...
      if (isGelatoBaseTxWithoutTimestamp(transaction)) {
        ...
        const txPool2 = get().transactionsPool;
    ...
    checkIsGelatoAvailable: async (chainId) => {
      try {
        ...
        if (!response.ok) {
          ...
          const listOfRelays = await response.json();
  ...
  return (set, get) => ({
      ...
      if (wallet.isActive) {
        if (wallet.chain) {
          ...
          if (client && walletClient) {
            ...
            const isContractAddress = await get().checkIsContractWallet(walletWithClients);
    ...
    connectWallet: async (walletType) => {
      ...
      const connector = get().connectors.find(
        (connector2) => getConnectorName(connector2) === walletType
      );
      try {
        if (connector) {
    ...
    checkAndSwitchNetwork: async (chainId) => {
      const activeWallet = get().activeWallet;
      if (chainId && activeWallet && activeWallet.chain?.id && activeWallet.chain.id !== chainId) {
        set({ isActiveWalletSetting: true });
    ...
    changeActiveWalletAccount: async (account) => {
      const activeWallet = get().activeWallet;
      if (account && account.address && activeWallet && activeWallet.isActive && activeWallet.address !== account.address && !get().isActiveWalletAccountChanging) {
    ...
    changeActiveWalletChain: async (chain) => {
      const activeWallet = get().activeWallet;
      if (chain !== void 0 && activeWallet && activeWallet.isActive && activeWallet.chain && activeWallet.chain.id !== chain.id && !get().isActiveWalletChainChanging) {
