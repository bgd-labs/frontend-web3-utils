...
var initAllConnectors = function initAllConnectors(props) {
  var metaMask = core.initializeConnector(function (actions) {
  ...
  var walletConnect = core.initializeConnector(function (actions) {
  ...
  var coinbase = core.initializeConnector(function (actions) {
  ...
  var impersonatedConnector = core.initializeConnector(function (actions) {
...
function getConnectorName(connector) {
  if (connector instanceof metamask.MetaMask) return "Metamask";
  if (connector instanceof walletconnect.WalletConnect) return "WalletConnect";
...
function Web3Provider(_ref2) {
  ...
  return React__default.createElement(core.Web3ReactProvider, {
    connectors: connectors
...
exports.createWeb3Slice = createWeb3Slice;
